---
description: Universal Rule of 5 review for any work artifact (code, plans, research, specs, docs)
---

# Universal Rule of 5 Review

Review any work artifact using Steve Yegge's Rule of 5 - five stages of iterative editorial refinement until convergence.
...
**Domain guidance:**
- **Code:** Architecture, design patterns, major functions/classes
- **Plans:** Phase structure, dependencies, overall approach
- **Research:** Sections, flow, research questions coverage
- **Issues:** Title appropriateness, basic description presence
- **Specs:** Requirements structure, completeness at high level
...
**Domain guidance:**
- **Code:** Syntax errors, logic bugs, algorithm correctness, data structure usage
- **Plans:** Feasibility issues, impossible dependencies, resource misestimates
- **Research:** Factual errors, incorrect citations, wrong conclusions from data
- **Issues:** Impossible scope, contradictory requirements, technical impossibilities
- **Specs:** Contradictory requirements, infeasible features, wrong assumptions
...
**Domain guidance:**
- **Code:** Variable/function names, comments, code organization, complexity
- **Plans:** Phase descriptions, success criteria clarity, instruction specificity
- **Research:** Term definitions, logical flow, transitions, accessibility
- **Issues:** Description clarity, actionability, context sufficiency
- **Specs:** Requirement clarity, unambiguous language, examples provided
...
**Domain guidance:**
- **Code:** Null checks, empty arrays, max values, error handling, race conditions
- **Plans:** Rollback strategies, blocked scenarios, resource unavailability, assumption failures
- **Research:** Alternative explanations, conflicting evidence, unanswered questions, limitations
- **Issues:** Acceptance criteria gaps, unclear done conditions, edge scenarios
- **Specs:** Corner cases, conflicting requirements, missing scenarios, error states
...
**Domain guidance:**
- **Code:** Performance, style, documentation, test coverage, maintainability
- **Plans:** Implementability, completeness, TDD approach, verification steps
- **Research:** Actionability, recommendations, references, presentation quality
- **Issues:** Executability, priority, labels, handoff readiness
- **Specs:** Testability, completeness, stakeholder readiness, sign-off criteria
